...
namespace QuestBuild_MVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, string Role)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (Role == "Студент")
                    {
                        return RedirectToAction("RegisterContinuation", "Account");
                    }
                    else
                    {
                        return RedirectToAction("RegisterContinuation", "Account");
        ...
        //
        // GET: /Account/RegisterContinuation
        [Authorize(Roles="teacher")]
        public ActionResult RegisterContinuation()
        {
            return View();
        }

        //
        //POST: /Account/RegisterContinuation
        [HttpPost]
        [Authorize(Roles="teacher")]
        [ValidateAntiForgeryToken]
        public ActionResult RegisterContinuation(RegisterOfTeacherViewModel model)
        {
            if (ModelState.IsValid)
            {
